    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex items-center justify-between h-20">
          ...
          {/* Desktop Navigation Links - UPDATED from <a> to <Link> */}
        ...
        {/* Mobile Menu Dropdown - UPDATED from <a> to <Link> */}
        <div
          ...
          <div className="py-4 space-y-1 border-t border-neutral-border dark:border-neutral-border-dark">
            {navLinks.map((link, index) => (
              <Link
                ...
                style={{
                  animation: isOpen
                    ? `slideDown 0.5s ease-out ${index * 0.05}s both`
                    : 'none',
                }}
              >
                {link.label}
