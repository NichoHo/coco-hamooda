...
export default function Footer() {
  ...
  return (
    <footer className="bg-secondary dark:bg-neutral-dark border-t border-neutral-border-dark">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col space-y-3">
              <a
                href="tel:+962795556767"
                className="inline-flex items-center gap-2 font-inter text-sm text-gray-400 hover:text-primary transition-colors duration-300 w-fit"
              >
                <svg 
                  className="w-5 h-5" 
                  fill="none" 
