    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 z-0">
        <div
          ...
          style={{
            backgroundImage: `url('/charcoal.jpg')`, // fixed closing parenthesis
          }}
        />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-12 text-center">
        ...
        {/* Flags pill — Jordan & Indonesia */}
        <div className="mt-6 flex justify-center animate-fadeInUp animation-delay-300">
          <div
            aria-label="Proudly Jordanian, sourced from Indonesia"
            className="inline-flex items-center gap-3 rounded-full bg-white/85 text-neutral-900 border border-white/30 backdrop-blur px-4 py-2 shadow"
          >
            <span className="inline-flex items-center gap-2">
              {/* Jordan */}
              <span className="fi fi-jo text-[22px] leading-none rounded-[2px]" aria-hidden="true" />
              <span className="text-sm font-semibold">Jordan</span>
            </span>
            ...
            <span className="inline-flex items-center gap-2">
              {/* Indonesia */}
              <span className="fi fi-id text-[22px] leading-none rounded-[2px]" aria-hidden="true" />
